...
<template>
  ...
  <main>
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="100%" id="blobSvg"
      style="opacity: 1;" filter="blur(8px)" transform="rotate(90)">
      <path id="blob" fill="url(#gradient)" style="opacity: .35;">
      ...
      <defs>
        <linearGradient id="gradient" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" style="stop-color: #83ecec;"></stop>
          <stop offset="100%" style="stop-color: #fab1a0;"></stop>
        </linearGradient>
      </defs>
    </svg>
    <HelloThere />
